...
public class UserService {
    ...
    public boolean existsByUserGroupIdAndStatus(Integer userGroupId, StatusEnum status) {
        return userRepository.countUsersByUserGroupAndStatus(userGroupId, status) > 0;
    }
